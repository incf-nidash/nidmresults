...
#                     ):
#                         attributes.setdefault(child_class, {prop}).add(prop)
...
#                     for restriction_node in my_owl_graph.objects(
#                         range_name, OWL["withRestrictions"]
#                     ):
#                         for first_restriction in my_owl_graph.objects(
...
#                                 for min_incl in my_owl_graph.objects(
...
#             # Read owl (turtle) file
#             import_graph = Graph()
#             import_txt = open(import_file).read()
...
#             key = "\n Unrecognised sub-type: " + example_graph.qname(
#                 not_recognised_sub_type
#             )
...
#                     if p in owl_ranges:
#                         owl_range_line = ", ".join(
#                             map(example_graph.qname, sorted(owl_ranges[p]))
#                         )
