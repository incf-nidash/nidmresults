...
""" + oid_var + """ a nidm_SearchSpaceMaskMap: ;
    ...
    def load_from_json(klass, json_dict, base_dir):
        ...
        vol_in_voxels = json_dict["Inferences"]["SearchSpaceMaskMap_searchVolumeInVoxels"]
        vol_in_units = json_dict["Inferences"]["SearchSpaceMaskMap_searchVolumeInUnits"]
        ...
        # "SearchSpaceMaskMap_expectedNumberOfClusters": 0.05129329438754778,
        # "SearchSpaceMaskMap_heightCriticalThresholdFWE05": 4.852417456895391,
        # "SearchSpaceMaskMap_heightCriticalThresholdFDR05": 5.763953685760498,
        # "SearchSpaceMaskMap_smallestSignificantClusterSizeInVoxelsFWE05": 12,
        # "SearchSpaceMaskMap_smallestSignificantClusterSizeInVoxelsFDR05": 29,

        coordspace = CoordinateSpace.load_from_json(
            json_dict,
            os.path.join(base_dir, search_space_file))

        sm = SearchSpace(
            search_space_file, vol_in_voxels, vol_in_units,
            vol_in_resels, resel_size_in_voxels,
            random_field_stationarity, noise_fwhm_in_voxels,
            noise_fwhm_in_units, coordspace)
