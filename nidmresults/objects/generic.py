...
from nidmresults.objects.constants import (
    ...
    NFO,
    NIDM,
    NIDM_COORDINATE_SPACE,
    NIDM_DIMENSIONS_IN_VOXELS,
    NIDM_FSL,
    NIDM_ICBM452_AIR_COORDINATE_SYSTEM,
    NIDM_ICBM452_WARP5_COORDINATE_SYSTEM,
    NIDM_ICBM_MNI152_LINEAR_COORDINATE_SYSTEM,
    ...
    NIDM_IN_WORLD_COORDINATE_SYSTEM,
    NIDM_IXI549_COORDINATE_SYSTEM,
    NIDM_MNI305_COORDINATE_SYSTEM,
    NIDM_MNI_COORDINATE_SYSTEM,
    NIDM_NIDM_RESULTS_EXPORT,
    NIDM_NUMBER_OF_DIMENSIONS,
    NIDM_RESULTS,
    NIDM_SOFTWARE_VERSION,
    NIDM_TALAIRACH_COORDINATE_SYSTEM,
    NIDM_VERSION,
    NIDM_VOXEL_SIZE,
